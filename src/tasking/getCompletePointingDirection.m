function dirPointingFull = getCompletePointingDirection(dirPointing, pointingDirBody)
    ...
    pointingAngles = convertPositionToRaDec(dirPointing);
    DCM_BODY2LOCAL_Y = getRotationMatrix_Y(pointingAngles(2))';
    DCM_BODY2LOCAL_Z = getRotationMatrix_Z(pointingAngles(1));
    dirPointingFull = DCM_BODY2LOCAL_Z * DCM_BODY2LOCAL_Y * pointingVectorBody;
end